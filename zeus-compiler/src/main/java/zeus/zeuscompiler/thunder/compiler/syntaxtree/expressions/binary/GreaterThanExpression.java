...
import zeus.shared.formula.binary.GreaterFormula;
...
public class GreaterThanExpression extends BinaryExpression {
  ...
  public Formula toFormula(Map<String, VariableInformation> variables) {
    return new GreaterFormula(this.leftExpression.toFormula(variables), this.rightExpression.toFormula(variables));
  }
