...
import zeus.shared.formula.binary.DivideFormula;
...
public class DivideExpression extends BinaryExpression {
  ...
  public Formula toFormula(Map<String, VariableInformation> variables) {
    return new DivideFormula(this.leftExpression.toFormula(variables), this.rightExpression.toFormula(variables));
  }
