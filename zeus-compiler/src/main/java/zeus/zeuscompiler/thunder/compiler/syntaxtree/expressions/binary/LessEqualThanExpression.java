...
public class LessEqualThanExpression extends BinaryExpression {
  public LessEqualThanExpression(
    int line,
    int linePosition,
  ...
  public Formula toFormula(Map<String, VariableInformation> variables) {
    return new LessEqualFormula(this.leftExpression.toFormula(variables), this.rightExpression.toFormula(variables));
  }
