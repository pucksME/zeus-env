...
import zeus.shared.formula.binary.GreaterEqualFormula;
...
public class GreaterEqualThanExpression extends BinaryExpression {
  public GreaterEqualThanExpression(
    int line,
    int linePosition,
  ...
  public Formula toFormula(Map<String, VariableInformation> variables) {
    return new GreaterEqualFormula(this.leftExpression.toFormula(variables), this.rightExpression.toFormula(variables));
  }
